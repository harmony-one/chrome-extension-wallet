  ...
  <header class="header">
    <div class="header-top">
      ...
      <div class="header-lock">
        <a v-if="wallets.accounts.length > 0" @click="lockWallet" v-tooltip.bottom="'Lock wallet'">
      ...
      <a class="refresh-toggle" @click.prevent="refreshData" href="#" v-tooltip.bottom="'Refresh'">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon">
          <path
